 ...
 *         &lt;element name="PushNotificationsUrl" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "DcLogin", propOrder = {
...
public class DcLogin {
    ...
    @XmlElementRef(name = "PushNotificationsUrl", namespace = "http://schemas.datacontract.org/2004/07/EDelivery.Common.DataContracts", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pushNotificationsUrl;
    ...
    /**
     * Gets the value of the pushNotificationsUrl property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getPushNotificationsUrl() {
        return pushNotificationsUrl;
    }

    /**
     * Sets the value of the pushNotificationsUrl property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setPushNotificationsUrl(JAXBElement<String> value) {
        this.pushNotificationsUrl = value;
    }
