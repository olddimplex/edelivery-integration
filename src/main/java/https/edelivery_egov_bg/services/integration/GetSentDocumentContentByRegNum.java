...
@XmlRootElement(name = "GetSentDocumentContentByRegNum")
public class GetSentDocumentContentByRegNum {

    @XmlElementRef(name = "documentRegistrationNumber", namespace = "https://edelivery.egov.bg/services/integration", type = JAXBElement.class, required = false)
