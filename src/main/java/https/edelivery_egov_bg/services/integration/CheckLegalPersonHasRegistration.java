...
@XmlRootElement(name = "CheckLegalPersonHasRegistration")
public class CheckLegalPersonHasRegistration {

    @XmlElementRef(name = "eik", namespace = "https://edelivery.egov.bg/services/integration", type = JAXBElement.class, required = false)
