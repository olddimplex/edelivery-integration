...
@XmlRootElement(name = "CheckSubjectHasRegistration")
public class CheckSubjectHasRegistration {

    @XmlElementRef(name = "identificator", namespace = "https://edelivery.egov.bg/services/integration", type = JAXBElement.class, required = false)
